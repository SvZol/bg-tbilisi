...
FROM_NAME = os.getenv("FROM_NAME", "Бегущий город Тбилиси")
FRONTEND_URL = os.getenv("FRONTEND_URL", "http://localhost:3000")


def send_email(to: str, subject: str, html: str):
    """Отправляет письмо. Если SMTP не настроен — печатает в консоль (для разработки)."""
...
def send_verification_email(to: str, token: str):
    ...
    <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px;">
      <h2 style="color:#1c1917;">🏃‍♂️ Подтверждение email</h2>
      <p style="color:#57534e;">Спасибо за регистрацию в <strong>Бегущий город Тбилиси</strong>!</p>
    ...
    """
    send_email(to, "Подтвердите ваш email — Бегущий город Тбилиси", html)
...
def send_reset_email(to: str, token: str):
    ...
    <div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px;">
      ...
      <p style="color:#57534e;">Вы запросили сброс пароля для <strong>Бегущий город Тбилиси</strong>.</p>
    ...
    """
    send_email(to, "Сброс пароля — Бегущий город Тбилиси", html)
