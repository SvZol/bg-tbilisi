      ...
      <div className="bg-white border border-stone-200 rounded-2xl p-7 shadow-sm">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-right">
            <Link href="/forgot-password" className="text-sm text-stone-400 hover:text-orange-600 transition-colors">
              Забыли пароль?
            </Link>
          </p>
        </form>
        <p className="mt-5 text-sm text-stone-600 text-center">
          Нет аккаунта?{' '}
          <Link href="/register" className="text-orange-600 hover:text-orange-700 font-medium">Зарегистрироваться</Link>
        </p>
      </div>
    </div>
  )
